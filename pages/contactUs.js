  ...
  return (
    ...
    <div  style={{backgroundImage:`url(/secondary_bg.jpg)` , backgroundPosition:"center", backgroundSize:"cover"}} className='text-white   font-Montserrat font-thin w-full bg-[#1E1C59] py-[2em]  px-[3vw] ' >
            ...
            <form className= ' w-[80%] md:w-1/3   mx-auto flex flex-col gap-[1vw] md:gap-[1vw] 2xl:gap-[5px]  mt-[5em] '>
                        ...
                        <p className='text-center text-[10vw]  md:text-center md:text-[6vw] mt-[-4vw]   duration-500 hover:text-[orange]   hover:tracking-[.5em]  w-[100%] mx-auto font-bold 2xl:text-[90px] 2xl:mt-[-40px] '>US </p>
                    
                        <p className='text-center text-[2vw] leading-[5vw] md:leading-[2.5vw]    md:text-[1vw] font-light  w-[100%]  md:text-center leading-[4vw] 2xl:text-[20px] 2xl:leading-[1em]   '>CONNECT WITH US FROM ANYWHERE AROUND THE WORLD</p>
                        <div className='flex flex-col md:mt-[3vw] gap-[1vw] 2xl:text-[1em] 2xl:mt-[20px] 2xl:gap-[10px]'>
                            ...
                            name="name" 
                            className= 'bg-[transparent] border    focus:text-white   rounded-full p-[3vw] text-[3vw] md:text-[1.3vw] md:focus:text-[1.7vw] lg:focus:text-[0.9vw] lg:text-[0.85vw] md:p-[1.5vw] md:w-[100%] duration-700 2xl:p-[20px] 2xl:text-[1em] ' placeholder='Please Enter Your Name'/>
                        </div>
                        ...
                        <div className='flex flex-col  gap-[1vw] 2xl:gap-[10px]'>
                            ...
                            className= 'bg-[transparent] border    focus:text-white   rounded-full p-[3vw] text-[3vw] md:text-[1.3vw] md:focus:text-[1.7vw] lg:focus:text-[0.9vw] lg:text-[0.85vw] md:p-[1.5vw] md:w-[100%] duration-700  2xl:p-[20px] 2xl:text-[1em] ' placeholder='Please Enter Your Email'/>
                        </div>
                        ...
                        }} className='rounded-full text-[2.5vw] border w-2/5 mx-auto p-[2.5vw] text-white bg-background hover:bg-[orange] duration-300 hover:border-0 md:text-[1vw] md:p-[1.5vw] 2xl:text-[12px] 2xl:p-[20px]   '> SEND MESSAGE</button>
